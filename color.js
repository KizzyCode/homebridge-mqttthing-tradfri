 ...
 */
exports.cie_to_rgb = function(x, y, brightness = 255) {
    // Precompute values
	const z = 1.0 - x - y,
		Y = (Math.min(brightness, 254) / 254).toFixed(2),
		X = (Y / y) * x,
    	Z = (Y / y) * z;
 ...
 */
exports.rgb_to_cie = function(r, g, b) {
...
exports.hsv_to_rgb = function(h, s, v) {
    ...
    switch (i % 6) {
        case 0: var r = v, g = t, b = p; break;
        case 1: var r = q, g = v, b = p; break;
        case 2: var r = p, g = v, b = t; break;
        case 3: var r = p, g = q, b = v; break;
        case 4: var r = t, g = p, b = v; break;
        case 5: var r = v, g = p, b = q; break;
    }
...
exports.rgb_to_hsv = function(r, g, b) {
    ...
    switch (max) {
        case min: var h = 0; break;
        case r: var h = (g - b) + d * (g < b ? 6 : 0); h /= 6 * d; break;
        case g: var h = (b - r) + d * 2; h /= 6 * d; break;
        case b: var h = (r - g) + d * 4; h /= 6 * d; break;
    }
	
    return { h: +(h * 360).toFixed(4), s: +(s * 100).toFixed(4), v: +(v * 100).toFixed(4) };
}
 ...
 */
exports.cie_to_hsv = function(x, y) {
	const { r, g, b } = exports.cie_to_rgb(x, y);
	return exports.rgb_to_hsv(r, g, b);
}
 ...
 */
exports.hsv_to_cie = function(h, s, v) {
	const { r, g, b } = exports.hsv_to_rgb(h, s, v);
	return exports.rgb_to_cie(r, g, b);
}